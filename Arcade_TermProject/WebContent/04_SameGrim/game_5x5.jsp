...
<!--  
    ...
    */
    ...
    for(var i=1;i<=num;i++){
        ...
        if(i==13) str += '<div class = "inmenuBox5" id="card'+i+'"><img src="../resources/images/R1.jpg" width= "83px" height= "83px"></div>';
        else str += '<div class = "inmenuBox5" id="card'+i+'"><img src="../resources/images/New_Themes/' + img + '" width= "83px" height= "83px"></div>';
    }
    ...
    function startGame() {
        ...
        setTimeout(function(){
            clearInterval(inte);
            $('#countDown').text('가운데 라이언이 자동으로 열립니다!!!!');
    ...
    $(document).on('click', '#card div', function(){
        ...
        if(open1 == ''){
            ...
            if(oSrc == oSrc2){ //일치
                ...
                if(++point_num == 12){
                    alert('Clear!!!! (Your Score:'+score+') !!짝짝짝짝');
                }
            }else{//불일치
    ...
    function scoreMinus(){
        ...
        if(score <= -100) {
            ...
            alert(score+"점: 실격입니다!"); for(var i=1;i<=5*5;i++) { strstr = '#card'+i; $(strstr).find('img').show(); }
	...
	<div class = "bodyBox">
        ...
        <div class = "TitleBox">
            <div style = "border-style: solid; border-color: black; color: black; background-color: white">
                <span class = "red">5x5</span> 같은 그림 찾기 <span style="display:inline-block; width:200px; "><button id='startBtn'>게임시작</button><button id='scoreBtn'>점수:<span id="score" style="font-size: 14;">0</span></button>       
            </div>
        </div>
            <div id='countDown'>
                시작버튼을 눌러 게임을 시작하세요!!
