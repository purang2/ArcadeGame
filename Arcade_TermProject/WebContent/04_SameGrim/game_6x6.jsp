...
<body>
    ...
    */
    ...
    for(var i=1;i<=num;i++){
        ...
        str += '<div class = "inmenuBox6" id="card'+i+'"><img src="../resources/images/New_Themes/' + img + '" width= "68px" height= "68px"></div>';
    }
    ...
    function scoreMinus(){
        ...
        if(score <= -100) {
            ...
            alert(score+"점: 실격입니다!"); for(var i=1;i<=6*6;i++) { strstr = '#card'+i; $(strstr).find('img').show(); }
	...
	<div class = "bodyBox">
        ...
        <div class = "TitleBox">
            <div style = "border-style: solid; border-color: black; color: black; background-color: white">
                <span class = "red">6x6</span> 같은 그림 찾기 <span style="display:inline-block; width:200px; "><button id='startBtn'>게임시작</button><button id='scoreBtn'>점수:<span id="score" style="font-size: 14;">0</span></button>       
            </div>
        </div>
            <div id='countDown'>
                시작버튼을 눌러 게임을 시작하세요!!
