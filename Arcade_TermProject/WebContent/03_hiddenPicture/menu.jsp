...
<div class="container">
	...
	<div class="box" id="game">
		<span><a class="game" href="../02_FDI/FDIMenu.jsp">틀린그림찾기</a></span>
		<span><a class="game" href="hiddenPicture.jsp">숨은그림찾기</a></span>
...
<%
	if(login)
		out.println("<a href = 'logout_process.jsp' role = button>로그아웃</a>");
	else
	{
		out.println("<a href = 'login.jsp' role = button>로그인</a>");
		out.println("<a href = 'signup.jsp' role = button>회원가입</a>");		
	}
%>
	</div>
</div>